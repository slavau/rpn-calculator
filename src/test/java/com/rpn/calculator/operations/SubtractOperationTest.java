...
public class SubtractOperationTest {
    ...
    private SubtractOperation operation = new SubtractOperation();
    ...
    @Test
    public void willPerformSubtractOnOperands() {
        Optional<Operand> result = operation.perform(Operands.of(Operand.valueOf(10), Operand.valueOf(1)));
        assertThat(result.get(), is(Operand.valueOf(9)));
    }
}